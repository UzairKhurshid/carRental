                ...
                <div id="view-borderless-table">
                    ...
                    <div class="col s12">
                        ...
                        <tbody>
                            ...
                            <td><a href="<?php echo base_url(); ?>Admin/delContact/<?php echo $d['id']; ?>">Delete</a></td>
                            <td><a href="<?php echo base_url(); ?>Admin/replyContact/<?php echo $d['id']; ?>">Reply</a></td>
                            <td></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
