         ...
         <div id="flight-card" class="card animate fadeUp">
            ...
            <div class="card-content-bg white-text">
               <div class="card-content">
                  ...
                  <br><br><br>
                  <form <?php echo form_open('Users/reserveDeal'); ?>>
                     
                     <input type="hidden" name="dealID" value="<?php echo $data['id']; ?>">
                     <button  class="btn waves-effect waves-light border-round gradient-45deg-purple-deep-orange col s12">Get This Deal</button>
